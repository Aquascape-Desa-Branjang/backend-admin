...
class Import extends Model
{
    ...
    public function user(): BelongsTo
    {
        ...
        if (! class_exists(\App\Models\Main\Admin::class)) {
            throw new Exception('No [App\\Models\\Main\\Admin] model found. Please bind an authenticatable model to the [Illuminate\\Contracts\\Auth\\Authenticatable] interface in a service provider\'s [register()] method.');
        }

        return $this->belongsTo(\App\Models\Main\Admin::class, 'user_id');
    }
